...
export function FavoriteCard(){
    ...
    return(
        <div className="w-full h-full bg-gray-900 p-4 text-white rounded-lg flex justify-between flex-col">
            { showInput ? (
                <div className='flex items-center justify-center gap-3'>
                    <input 
                    className='w-full rounded-md h-8 bg-white text-black px-2'
                    type="text"
                    value={input}
